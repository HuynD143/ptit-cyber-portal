...
import { ArrowLeft, Terminal, Copy, Power, Server, ExternalLink, Flag, CheckCircle } from 'lucide-react';
import TerminalWindow from '../components/ui/TerminalWindow';

const getChallengeData = (id) => {
  const challenges = {
    1:  { title: 'Hidden Message in PNG',              difficulty: 'Dễ',        points: 100 },
    2:  { title: 'Classic Caesar Cipher',               difficulty: 'Dễ',        points: 100 },
    3:  { title: 'Base64 Chained Encoding',             difficulty: 'Dễ',        points: 100 },
    4:  { title: 'EXIF Data Leak',                      difficulty: 'Dễ',        points: 100 },
    5:  { title: 'Broken RSA Public Key',               difficulty: 'Trung bình', points: 300 },
    6:  { title: 'SQL Injection Login Bypass',          difficulty: 'Trung bình', points: 300 },
    7:  { title: 'JWT None Algorithm Attack',           difficulty: 'Trung bình', points: 300 },
    8:  { title: 'PCAP Flag Recovery',                  difficulty: 'Trung bình', points: 300 },
    9:  { title: 'XOR Keystream Recovery',              difficulty: 'Trung bình', points: 300 },
    10: { title: 'Blind XXE via SVG Upload',            difficulty: 'Trung bình', points: 300 },
    11: { title: 'Format String Leak (PIE bypass)',     difficulty: 'Khó',        points: 500 },
    12: { title: 'Heap Feng Shui',                      difficulty: 'Khó',        points: 500 },
    13: { title: 'Kernel ROP Chain',                    difficulty: 'Khó',        points: 500 },
    14: { title: 'Reverse Engineering Obfuscated VM',   difficulty: 'Khó',        points: 500 },
    15: { title: 'ECDSA Nonce Reuse Attack',            difficulty: 'Khó',        points: 500 },
    16: { title: 'DNS Exfiltration via PCAP',           difficulty: 'Trung bình', points: 300 },
    17: { title: 'HTTP Request Smuggling',              difficulty: 'Khó',        points: 500 },
    18: { title: 'LSB Steganography Extraction',        difficulty: 'Dễ',         points: 100 },
    19: { title: 'Android APK Secret Flag',             difficulty: 'Khó',        points: 500 },
    20: { title: 'Padding Oracle Attack (CBC)',         difficulty: 'Khó',        points: 500 },
  };
  return challenges[id] || { title: 'CTF Challenge', difficulty: 'Trung bình', points: 300 };
};
